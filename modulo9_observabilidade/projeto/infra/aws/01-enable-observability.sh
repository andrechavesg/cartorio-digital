...
aws cloudwatch put-dashboard \
  ...
  --dashboard-body "{\"widgets\":[{\"type\":\"metric\",\"x\":0,\"y\":0,\"width\":12,\"height\":6,\"properties\":{\"metrics\":[[\"AWS/ApiGateway\",\"Latency\",\"ApiName\",\"cartorio-${ENVIRONMENT}-api\"]],\"stat\":\"Average\",\"period\":60,\"title\":\"Latência API\"}}]}"
